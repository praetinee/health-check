...
def cbc_advice(hb_result, wbc_result, plt_result):
    ...
    hb_result = hb_result.strip()
    wbc_result = wbc_result.strip()
    plt_result = plt_result.strip()

    if hb_result == "พบภาวะโลหิตจาง" and wbc_result == "เม็ดเลือดขาวปกติ" and plt_result == "เกล็ดเลือดปกติ":
        return "ให้ดูแลสุขภาพร่างกายให้แข็งแรง หลีกเลี่ยงการอยู่ในที่ชุมชนที่มีโอกาสสัมผัสเชื้อโรคได้ง่าย และให้ทำการรักษาอย่างต่อเนื่องสม่ำเสมอ หากมีอาการผิดปกติ เช่น มีไข้ หนาวสั่น ท้องเสียเรื้อรัง ควรรีบมาพบแพทย์"

    if hb_result == "พบภาวะโลหิตจาง" and wbc_result != "เม็ดเลือดขาวปกติ":
        return "ให้รับประทานอาหารที่มีประโยชน์ เช่น นม ผักใบเขียว ถั่วเมล็ดแห้ง เนื้อสัตว์ ไข่ เป็นต้น พักผ่อนให้เพียงพอ หลีกเลี่ยงการอยู่ในที่ชุมชนที่มีโอกาสสัมผัสเชื้อโรคได้ง่าย ดูแลสุขภาพร่างกายให้แข็งแรง ถ้ามีหน้ามืดวิงเวียน อ่อนเพลียหรือมีไข้ให้พบแพทย์"

    if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and wbc_result == "เม็ดเลือดขาวปกติ" and plt_result == "เกล็ดเลือดปกติ":
        return "ให้ดูแลสุขภาพร่างกายให้แข็งแรง หลีกเลี่ยงการอยู่ในที่ชุมชนที่มีโอกาสสัมผัสเชื้อโรคได้ง่าย และให้ทำการรักษาอย่างต่อเนื่องสม่ำเสมอ"

    if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and wbc_result != "เม็ดเลือดขาวปกติ" and plt_result == "เกล็ดเลือดปกติ":
        return "ติดตามภาวะโลหิตจางและเม็ดเลือดขาวอย่างใกล้ชิด"

    if hb_result == "ความเข้มข้นของเลือดปกติ" and wbc_result != "เม็ดเลือดขาวปกติ":
        return "ให้นำผลตรวจพบแพทย์หาสาเหตุภาวะโลหิตจาง หรือกรณีรู้สาเหตุให้รับการรักษาเดิมและดูแลสุขภาพให้แข็งแรงหลีกเลี่ยงการอยู่ในชุมชนที่มีโอกาสสัมผัสเชื้อโรคได้ง่าย และทำการรักษาอย่างต่อเนื่อง"

    if plt_result in ["เกล็ดเลือดต่ำกว่าเกณฑ์ปกติ", "เกล็ดเลือดต่ำกว่าเกณฑ์ปกติเล็กน้อย"]:
        return "ให้นำผลการตรวจพบแพทย์เพื่อรักษาตามนัดเดิม กรณีไม่ได้รักษาให้พบแพทย์ตรวจหาสาเหตุ"

    if plt_result == "เกล็ดเลือดสูงกว่าเกณฑ์ปกติ":
        return "ให้นำผลตรวจพบแพทย์หาสาเหตุเกร็ดเลือดสูงกว่าปกติ หรือกรณีรู้สาเหตุให้รับการรักษาเดิม"

    if hb_result == "ความเข้มข้นของเลือดปกติ" and wbc_result == "เม็ดเลือดขาวปกติ" and plt_result == "เกล็ดเลือดปกติ":
        return ""

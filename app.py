...
def cbc_advice(hb_result, wbc_result, plt_result):
    ...
    if hb_result == "พบภาวะโลหิตจาง" and \
       wbc_result in ["ต่ำกว่าเกณฑ์", "ต่ำกว่าเกณฑ์เล็กน้อย", 
                      "สูงกว่าเกณฑ์เล็กน้อย", "สูงกว่าเกณฑ์"]:
    ...
    if plt_result in ["ต่ำกว่าเกณฑ์", "ต่ำกว่าเกณฑ์เล็กน้อย"]:

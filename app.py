...
def cbc_advice(hb_result, wbc_result, plt_result):
    ...
    if hb_result == "ความเข้มข้นของเลือดปกติ" and \
       wbc_result == "เม็ดเลือดขาวปกติ" and \
       plt_result == "เกล็ดเลือดปกติ":
        return ""  # ไม่มีคำแนะนำเมื่อทุกอย่างปกติ

    if hb_result == "พบภาวะโลหิตจาง" and \
       wbc_result == "เม็ดเลือดขาวปกติ" and \
       plt_result == "เกล็ดเลือดปกติ":
        return "แนะนำพบแพทย์เพื่อตรวจหาสาเหตุของภาวะโลหิตจาง"

    if hb_result == "พบภาวะโลหิตจาง" and \
       wbc_result in ["เม็ดเลือดขาวต่ำกว่าเกณฑ์ปกติ", "เม็ดเลือดขาวต่ำกว่าเกณฑ์ปกติเล็กน้อย", 
                      "เม็ดเลือดขาวสูงกว่าเกณฑ์ปกติเล็กน้อย", "เม็ดเลือดขาวสูงกว่าเกณฑ์ปกติ"]:
        return "ควรตรวจ CBC เพิ่มเติม และพิจารณาปรึกษาแพทย์"

    if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and \
       wbc_result == "เม็ดเลือดขาวปกติ" and \
       plt_result == "เกล็ดเลือดปกติ":
        return "แนะนำติดตามระดับเลือดซ้ำใน 3-6 เดือน"

    if hb_result == "ความเข้มข้นของเลือดปกติ" and \
       wbc_result in ["เม็ดเลือดขาวต่ำกว่าเกณฑ์ปกติ", "เม็ดเลือดขาวต่ำกว่าเกณฑ์ปกติเล็กน้อย", 
                      "เม็ดเลือดขาวสูงกว่าเกณฑ์ปกติเล็กน้อย", "เม็ดเลือดขาวสูงกว่าเกณฑ์ปกติ"]:
        return "ควรตรวจ CBC ซ้ำเพื่อติดตามแนวโน้มเม็ดเลือดขาว"

    if plt_result in ["เกล็ดเลือดต่ำกว่าเกณฑ์ปกติ", "เกล็ดเลือดต่ำกว่าเกณฑ์ปกติเล็กน้อย"]:
        return "ควรตรวจ platelet เพิ่มเติมและพิจารณาโรคที่เกี่ยวข้อง"

    if plt_result == "เกล็ดเลือดสูงกว่าเกณฑ์ปกติ":
        return "อาจเกี่ยวข้องกับการอักเสบเรื้อรังหรือภาวะอื่น ๆ ควรตรวจเพิ่มเติม"

    if hb_result == "พบภาวะโลหิตจางเล็กน้อย" and \
       wbc_result not in ["เม็ดเลือดขาวปกติ"] and \
       plt_result == "เกล็ดเลือดปกติ":
